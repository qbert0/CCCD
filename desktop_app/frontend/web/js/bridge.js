...
CCCD.bridgeReady = new Promise((resolve) => {
  new QWebChannel(qt.webChannelTransport, (channel) => {
    ...
    CCCD.bridge = {
      ...
      clearRepresentativeSignature: () => call("clear_representative_signature"),
      chooseCustomerRepresentativeSignature: () => call("choose_customer_representative_signature"),
      getRepresentative2Profile: () => call("get_representative_2_profile"),
      getRepresentative2ProfileLayout: () => call("get_representative_2_profile_layout"),
      saveRepresentative2Profile: (personObj) => call("save_representative_2_profile", JSON.stringify(personObj)),
      chooseRepresentative2Signature: () => call("choose_representative_2_signature"),
      clearRepresentative2Signature: () => call("clear_representative_2_signature"),
      ...
      clearProviderSignature: () => call("clear_provider_signature"),
